...
class Teahouse_Testimonials{
    public function __construct(){
        ...
        add_action('init',  array($this, 'dpc_register_testimonials_post_type'));
    }

   public function dpc_register_testimonials_post_type() {
        $labels = array(
...
$teahouse_testimonials= new Teahouse_Testimonials;
endif;
